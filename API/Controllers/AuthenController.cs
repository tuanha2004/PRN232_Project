...
namespace API.Controllers
{
	...
	public class AuthenController : ControllerBase
	{
		...
		public AuthenController(ProjectPrn232Context context, JwtService jwtService, IEmailService emailService)
		{
			_context = context;
	...
	public async Task<ActionResult> ForgotPassword([FromBody] ForgotPasswordRequest request)
	{
		...
		try
		{
			...
			await _emailService.SendResetPasswordEmailAsync(user.Email!, resetCode);
